  ...
  <main>
    ...
    <div class="userInfo">
      <div id="username">
        ...
        <div class="control">
          <input
            v-model="com"
            id="name"
            placeholder="Ex. John Smith Plumbing"
            class="input"
            type="text"
          />
        </div>
      ...
      <div id="service">
        ...
        <div class="control" id="info">
          <input class="input" placeholder="Ex. Plumber" type="text" />
          <!-- v-model="" -->
        </div>
      </div>
      <div id="price">
        ...
        <div class="control" id="info">
          <input class="input" placeholder="Ex. $190" type="text" />
          <!-- v-model="" -->
        </div>
      </div>
      <div id="description">
        ...
        <div class="control" id="info">
          <textarea
            id="freeform"
            placeholder="Ex. My name is John and I am a skilled plumber..."
            name="freeform"
            rows="4"
            cols="50"
          ></textarea>
